...
enum class Unidade (val short: String,
    ...
    CELSIUS("c", "degree Celsius", "degrees Celsius", 1.0, "Temperature"),
    KELVIN("k","kelvin", "kelvins", 1.0, "Temperature"),
    FAHRENHEIT("f", "degree Fahrenheit", "degrees Fahrenheit", 1.0, "Temperature");
}
...
fun getUnit(unit: String): Unidade =
    when (unit) {
        ...
        "degree celsius", "degrees celsius", "celsius", "dc", "c" -> Unidade.CELSIUS
        "degree fahrenheit", "degrees fahrenheit", "fahrenheit", "df", "f" -> Unidade.FAHRENHEIT
        "kelvin", "kelvins", "k" -> Unidade.KELVIN
